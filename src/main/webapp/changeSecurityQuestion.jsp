...
{
%>
<h3 class="alert">Your Password is wrong!</h3>i
<%} %>
...
<option value="What is the name of the town where you wre born?">What is the name of the town where you were born?</option>
</select>
