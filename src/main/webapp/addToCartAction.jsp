...
<%
   ...
   try
   {
	    ...
	    Statement st=cn.createStatement();
	     ...
	     ResultSet r = st.executeQuery("select * from product where id='"+product_id+"'");
	       while(r.next())
	       {
	    	   product_price=r.getInt(4);
	    	   product_total=product_price;
	    	   
	       }
	       ResultSet r1 = st.executeQuery("select * from cart where product_id='"+product_id+"'and email='"+email+"' and address is NULL");
